...
graph TB
    ...
    subgraph construction["网络构建 (Network Construction)"]
        subgraph neurons["神经元模型 (Neuron Models)"]
        ...
        subgraph synapses["突触模型 (Synapse Models)"]
    ...
    classDef configStyle fill:#f3e5f5,stroke:#7b1fa2,stroke-width:3px,color:#000;
    classDef constructStyle fill:#e3f2fd,stroke:#1976d2,stroke-width:3px,color:#000;
    classDef simStyle fill:#fff3e0,stroke:#f57c00,stroke-width:3px,color:#000;
    classDef monitorStyle fill:#efebe9,stroke:#5d4037,stroke-width:3px,color:#000;
    classDef learnStyle fill:#e8f5e9,stroke:#388e3c,stroke-width:3px,color:#000;
